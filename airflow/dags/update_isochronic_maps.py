...
@dag(
    dag_id="update_isochronic_maps",
    start_date=datetime(2024, 1, 1),
    schedule="0 2 * * 0",  # Run weekly on Sundays at 2 AM
    catchup=False,
    ...
    tags=["maps", "isochronic", "weekly"]
)
def update_isochronic_maps_dag():
